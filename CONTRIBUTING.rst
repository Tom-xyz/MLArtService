...
Welcome to ``MLArtService`` contributor's guide.
...
If you experience bugs or general issues with ``MLArtService``, please have a look
...
You can help improve ``MLArtService`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``MLArtService`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``MLArtService``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n MLArtService python=3 six virtualenv pytest pytest-cov
    conda activate MLArtService
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/MLArtService.git
    cd MLArtService
...
#. Install |pre-commit|_::
   ...
   ``MLArtService`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/MLArtService
.. _issue tracker: https://github.com/<USERNAME>/MLArtService/issues
.. <-- end -->
